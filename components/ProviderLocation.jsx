    ...
    <>
      <div>
        <h2 className="text-3xl text-center font-bold mb-1">
          Become A <br /> Professional
        </h2>
        <p className="text-center mb-14">
          Enter your location and contact number to
          <br /> proceed
        </p>
        <div
        ...
        >
          ...
          >
            <input
              type="text"
              className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-md"
